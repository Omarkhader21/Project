                    ...
                    @foreach($sproducts as $sproduct)
                        <div class="product product-style-2 equal-elem ">
                            ...
                            <div class="product-info">
                                ...
                                <div class="wrap-price"><ins><p class="product-price">{{$sproduct->sale_price}}</p></ins><del><p class="product-price">{{$sproduct->regular_price}}</p></del>
                            </div>
                        </div>
                    @endforeach
                </div>
                                    ...
                                    <div class="product product-style-2 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span
                                                    class="{{$lproduct->regular_price}}">$250.00</span></div>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
