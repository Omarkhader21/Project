...
{{--                                           wire:click.pervent="increaseQuantity('{{$item->rowId}}')"></a>--}}
...
{{--                                       wire:click.prevent="deleteItem('{{$item->rowId}}')">--}}
                ...
                <div class="order-summary">
                    ...
                    @if(\Illuminate\Support\Facades\Session::has('coupon'))
                        <p class="summary-info"><span class="title">Discount ({{Session::get('coupon')['code']}}) <a
                                    href="" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i></a></span><b
                ...
                <div class="checkout-info">
                    ...
                    @if($haveCouponCode==1)
                        <div class="summary-item">
                            <form wire:submit.prevent="applyCouponApply">
                        ...
                        <ul class="products-cart">
                            @foreach(Cart::instance('saveForLater')->content() as $item)
                                <li class="pr-cart-item">
                                    ...
                                    <div class="delete">
                                        <a href="#" class="btn btn-delete" title=""
                                           wire:click.prevent="deleteSave('{{$item->rowId}}')">
